        ...
        std::unique_ptr<std::vector<std::pair<int, float> *>> results(
                reinterpret_cast<std::vector<std::pair<int, float> *> *>(
                        ...
                        knn_jni::faiss_wrapper::RangeSearch(
                                &mockJNIUtil, jniEnv,
                                reinterpret_cast<jlong>(&createdIndexWithData),
                                reinterpret_cast<jfloatArray>(&query), radius, maxResultWindow, nullptr, 0, nullptr)));
        ...
        std::unique_ptr<std::vector<std::pair<int, float> *>> results(
                reinterpret_cast<std::vector<std::pair<int, float> *> *>(
                        ...
                        knn_jni::faiss_wrapper::RangeSearch(
                                &mockJNIUtil, jniEnv,
                                reinterpret_cast<jlong>(&createdIndexWithData),
                                reinterpret_cast<jfloatArray>(&query), radius, maxResultWindow, reinterpret_cast<jlongArray>(&bitmap), 0, nullptr)));
        ...
        std::unique_ptr<std::vector<std::pair<int, float> *>> results(
                reinterpret_cast<std::vector<std::pair<int, float> *> *>(
                        ...
                        knn_jni::faiss_wrapper::RangeSearch(
                                &mockJNIUtil, jniEnv,
                                reinterpret_cast<jlong>(&createdIndexWithData),
                                reinterpret_cast<jfloatArray>(&query), radius, maxResultWindow, nullptr, 0, reinterpret_cast<jintArray>(&parentIds))));
