...
public interface KNNLibrary {
    ...
    /**
     * Translate the distance input from end user to the right type radius for the library.
     *
     * @param distance  distance input from end user
     * @param spaceType spaceType used to compute the radius
     * @return translated radius
     */
    float distanceTranslation(float distance, SpaceType spaceType);
